...
SWIFT_CLASS("_TtC11iOS_Example11AppDelegate")
...
SWIFT_CLASS("_TtC11iOS_Example20DetailViewController")
...
@property (nonatomic, copy) NSString * _Nullable segueIdentifier;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, strong) NSNumberFormatter * _Nonnull numberFormatter;)
+ (NSNumberFormatter * _Nonnull)numberFormatter SWIFT_WARN_UNUSED_RESULT;
- (void)awakeFromNib;
...
@interface DetailViewController (SWIFT_EXTENSION(iOS_Example))
...
SWIFT_CLASS("_TtC11iOS_Example20MasterViewController")
